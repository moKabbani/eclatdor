...
export default function LangLayout({
  ...
  return (
    <html lang={lang} dir={isAr?'rtl':'ltr'}>
      <body style={{background:'#eaea', fontFamily:'system-ui', margin:0}}>
        ...
        <footer style={{background:'#0A0A0A', color:'#fff', padding:'60px 50px 24px', direction:'ltr'}}>
          <div style={{display:'grid', gridTemplateColumns:'1.6fr 1fr 1.6fr', gap:'40px', paddingBottom:'40px', borderBottom:'1px solid #1E1E1E', textAlign:'left'}}>
