  ...
  return (
    <main dir={isAr?'rtl':'ltr'} style={{background:'#fff', padding:'60px 20px'}}>
      ...
      <div className="product-grid">
        ...
        {/* الصور */}
        <div>
          <div style={{width:'100%', height:'500px', background:'#FDFCF8', borderRadius:'24px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center', marginBottom:'20px'}}>
